...
export default function CardItem({ icon, title, sub }: CartItemProps) {
  return (
    <SecctionInView className=' flex justify-start items-center min-w-[80%] md:min-w-[60%] mo:!min-w-[300px] px-3 py-2 hover:shadow-lg duration-200 shadow-md  rounded-xs gap-5 '>
